...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<typename T>
inline Matrix44<T>& Matrix44<T>::SetFromLookAtY (const Vector3<T>& vPos, const Vector3<T>& vTarget, const Vector3<T>& vUp)
{
  Vector3<T> vLookAt_eje_Y = (vTarget - vPos).Normalize();
  ...
  if(vUP.IsNotEqualEpsilon(v3fY))
  {
    if(vLookAt_eje_Y.IsEqualEpsilon(vUp, (T)0.0001))
    {
      vUP.y -= (T)0.1;
    }
    else
  ...
  Vector3<T> vRight_eje_X = vUp ^ vLookAt_eje_Y;
  vRight_eje_X.Normalize();
  Vector3<T> vFront_eje_Z = vRight_eje_X ^ vLookAt_eje_Y;

  SetFromBasis(vRight_eje_X, vLookAt_eje_Y, vFront_eje_Z, vPos);
