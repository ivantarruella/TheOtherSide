...
#include "NxPhysics.h"
#include "NxCooking.h"
#include "include\PhysicUserAllocator.h"
#include "PhysXLoader.h"
#include "include\PhysicStream.h"
#include "Base.h"
//--------------------------
...
bool  CPhysicCookingMesh::ReadMeshFromASE(std::string fileName, std::vector<Vect3f>&vertices, std::vector<unsigned int>& faces)
{
	if(m_pPhysicLoader.ReadMeshFromASE(fileName, vertices, faces))
	{
		return true;
	}
	return false;
