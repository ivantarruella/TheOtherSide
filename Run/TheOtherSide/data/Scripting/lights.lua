...
function luces_sala_inicial_MR_level01_ON()
	...
	_LIGHTM:set_light_active('Light03b_Omni_MR',true)
...
function luces_pasillo_MR_level01_ON()
	...
	_LIGHTM:set_light_active('Light03b_Omni_MR',false)
...
function luces_sala_inicial_ME_level01_ON()
	...
	_LIGHTM:set_light_active('Light02b_Omni_ME',true)
...
function luces_hall_piso1_level2_ON()
	...
	_LIGHTM:set_light_active('Omni_hall2_013', true)
	_LIGHTM:set_light_active('Omni_hall2_012', true)
	_LIGHTM:set_light_active('Omni_SControl005_2', true)
end
...
function luces_hall_piso1_level2_OFF()
	...
	_LIGHTM:set_light_active('Omni_hall2_013', false)
	_LIGHTM:set_light_active('Omni_hall2_012', false)
	_LIGHTM:set_light_active('Omni_SControl005_2', false)
end
