...
float Threshold = 0.15;				// Get the threshold of what brightness level we want to glow (1.0 = blanco)
float BloomIntensity = 1.2;			// Controls the Intensity of the bloom texture
