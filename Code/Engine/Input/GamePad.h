...
//
// Description:
// Esta clase gestiona el input de tipo GAMEPAD
...
#define INPUT_DEADZONE  ( 0.3f * FLOAT(0x7FFF) )  // Default to 30% of the +/- 32767 range.   This is a reasonable default value but can be altered if needed.
