...
*/
#include "include\PhysicSphericalJoint.h"
#include "include\PhysicRevoluteJoint.h"
#include "include\PhysicTriggerReport.h"
#include "include\PhysicFixedJoint.h"
...
void CPhysicsManager::SetTriggerReport (CPhysicTriggerReport* report)
{
	...
	m_pScene->setUserTriggerReport((NxUserTriggerReport*) report);
}
